    ...
    void setUp() {
        try (Connection testConnection = connectionPool.getConnection()) {
            try (Statement statement = testConnection.createStatement()) {
                ...
                statement.execute("INSERT INTO `carport`.`carport_request`(`carport_request_id`,`width`,`length`,`roof`,`roof_incline`,`is_approved`,`shed_length`,`shed_width`,`customer_id`) VALUES(1,600,780,'Plasttrapez',null,false,280,600,2)");
            }
